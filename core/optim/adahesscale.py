...
class AdaHesScaleAdamStyle(Optimizer):
    method = HesScale()
    def __init__(self, params, lr=1e-5, betas=(0.9, 0.999), eps=1e-8):
        ...
        super(AdaHesScaleAdamStyle, self).__init__(params, defaults)
...
class AdaHesScaleSqrt(Optimizer):
    method = HesScale()
    def __init__(self, params, lr=1e-5, betas=(0.9, 0.999), eps=1e-8):
        if not 0.0 <= lr:
            raise ValueError("Invalid learning rate: {}".format(lr))
        ...
        super(AdaHesScaleSqrt, self).__init__(params, defaults)
...
class AdaHesScale(Optimizer):
    ...
    def __init__(self, params, lr=1e-5, betas=(0.9, 0.999), eps=1e-8):
        ...
        super(AdaHesScale, self).__init__(params, defaults)
