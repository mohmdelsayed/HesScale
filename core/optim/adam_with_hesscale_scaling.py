...
class AdamHesScale(Optimizer):
    ...
    def __init__(
        ...
        defaults = dict(
            lr=lr, beta1=beta1, beta2=beta2, eps=eps, weight_decay=weight_decay, delta=delta, max_scale=max_scale, method_field=type(self).method.savefield
        )

        super(AdamHesScale, self).__init__(params, defaults)
