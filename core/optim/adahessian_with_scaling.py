# obtained from https://github.com/amirgholami/adahessian/blob/master/image_classification/optim_adahessian.py

from torch.optim.optimizer import Optimizer
import torch, math

class AdaHessianScaled(Optimizer):
    ...
    def __init__(self, params, lr=0.15, beta1=0.9, beta2=0.999, damping=1e-8, delta=1e-8, max_scale=1.0,
        ...
        defaults = dict(lr=lr, beta1=beta1, beta2=beta2, eps=damping,
                        weight_decay=weight_decay, delta=delta, max_scale=max_scale)
        self.single_gpu = single_gpu
        super(AdaHessianScaled, self).__init__(params, defaults)
    ...
    def step(self, closure=None):
        ...
        for (p, group, grad, hut_trace) in zip(params, groups, grads, hut_traces):
            ...
            trust_region_term += (exp_hessian_diag_sq.sqrt() * (state["u"] ** 2)).sum()
