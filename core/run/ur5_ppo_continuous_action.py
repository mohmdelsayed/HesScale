...
from SenseAct.senseact.envs.ur.reacher_env_v2 import ReacherEnvV2
from SenseAct.senseact.utils import NormalizedEnv
...
def main():
    ...
    # losses
    ac_mu_lossf = extend(GaussianNLLLossMuPPO(reduction="mean", eps=1e-6))
    ac_var_lossf = extend(GaussianNLLLossVarPPO(reduction="mean", eps=1e-6))
    cr_lossf = extend(nn.MSELoss())
